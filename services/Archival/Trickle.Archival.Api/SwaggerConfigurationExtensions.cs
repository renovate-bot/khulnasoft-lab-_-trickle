...
namespace Trickle.Archival.Api;
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        services.AddSwaggerGen(o =>
        {
            ...
            o.SwaggerDoc(
                ...
                new OpenApiInfo
                {
                    Title = "Trickle Archival API",
                    Description = "An ASP.NET Core API archiving and serving copies of Trickle for mirrors and analysis.",
                    Version = "v1",
                    //TermsOfService = "",
