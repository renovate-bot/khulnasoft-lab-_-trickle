...
public static class GetLicenses
{
    ...
    internal class LicenseVmProfile : Profile
    {
        ...
        {
            CreateMap<License, LicenseVm>().ForMember(l => l.TrickleIds,
                o => o.MapFrom(l => l.Trickle.OrderBy(fl => fl.Id).Select(fl => fl.Id)));
        }
    }
    ...
    public record LicenseVm
    {
        ...
        /// <summary>
        ///     The identifiers of the Trickle released under this License.
        /// </summary>
